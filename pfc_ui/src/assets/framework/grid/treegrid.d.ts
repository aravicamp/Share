interface TCalendar {
    ...
    OnGetCalendarDate(date: Date, text: string, classes: string[], range: boolean): string;
...
interface TGrid {
    ...
    AddCol(col: string, sec: number, pos: number, width: number, show?: boolean, type?: string, caption?: string): TCol;
    AddColPage(names: string[], def: string, updatefixed?: boolean): void;
    AddCols(cols: string[], tocol: string, right: boolean, empty?: boolean, focus?: boolean): TCol[];
    AddDataFromServer(Data: string): void;
    AddDependencies(Dependencies: Object[]): void;
    AddGanttRunBox(box: Object, adjust: string, id?: string, group?: string, test?: boolean): boolean;
    AddPage(name: string, xml: string, count: number): TRow;
    AddRow(parent: TRow, next: TRow, show?: number, id?: string, Def?: string): TRow;
    AddRows(count: number, parent: TRow, next: TRow, focus?: boolean, test?: boolean): TRow[];
    AjaxCall(Source: Object, Data: string, Func: Function): string;
    ApplyMedia(): boolean;
    ButtonClick(row: TRow, col: string): void;
    CalcWidth(col: string, noupdate?: boolean): void;
    ...
    ChangeFilter(cols: string, values: string, nofilter: string, noclear: boolean, filter: TRow): void;
    ...
    CopyRow(row: TRow, parent: TRow, next: TRow, deep?: boolean, empty?: boolean): TRow;
    CopyRows(rows: TRow[], parent: TRow, next: TRow, deep?: boolean, empty?: boolean): TRow[];
    CorrectDependencies(row: TRow, col: string, bar?: any): void;
    CorrectExclude(row: TRow, col: string, show?: boolean, objects?: string): void;
    CreateColPages(): void;
    CreatePages(): void;
    CreatePivot(func: Function): boolean;
    CustomUndo(Object: Object, Undo: Function, Redo: Function): void;
    Debug(type: number, arg1: string, arg2: string, arg3: string);
    ...
    ExpandAll(parent: TRow, loaded?: number, levels?: number, max?: number, test?: boolean): number;
    ...
    FindType(row: TRow, col: string, val: any, refresh?: boolean, calc?: boolean): string;
    Focus(row: TRow, col: string, pagepos?: number, Rect?: any[], type?: number): boolean;
    ...
    GetDefaultsIndex(row: TRow, col: string, val?: string): number;
    GetDefaultsValue(row: TRow, col: string, index: number): number;
    GetDependencies(row: TRow, col: string, ancestors?: boolean, row2?: TRow, type?: string, box?: string, box2?: string): Object[];
    ...
    GetGanttResourceCount(res: string, start: number, end: number, type: number, col: string, def: string): number;
    GetGanttResourcesUsage(def: string, row: TRow, col: string, units: string, bar: number, notmp: boolean): number[];
    ...
    GetGanttRunSelectedCount(row: TRow, col: string): number;
    ...
    GetScrollTop(): number;
    GetSections(): number[];
    GetSelCols(attr?: string);
    GetSelRanges(rowtype?: number, coltype?: number): Array<any>;
    ...
    IncGanttDate(start: number, dur: number, units?: string, beg?: boolean, col?: string, row?: TRow): number;
    IsCellExpanded(row: TRow, col: string): boolean;
    IsFocused(row: TRow, col: string): boolean;
    IsSelected(row: TRow, col: string);
    ...
    OnGanttMainChange(row: TRow, col: string, plan: number, newValue: Object, old: Object, action: string): Object;
    OnGanttMainChanged(row: TRow, col: string, plan: number, newValue: Object, old: Object, action: string): void;
    OnGetCellStyle(grid: TGrid, row: TRow, col: string, attr: string, value: any): any;
    ...
    SelectCol(col: string, select?: boolean, test?: boolean);
    SelectGanttRunBox(box: Object, select: boolean): boolean;
    SelectGanttRunRect(r1: TRow, x1: number, y1: number, r2: TRow, x2: number, y2: number, select?: boolean): boolean;
    SelectRange(row1: TRow, col1: string, row2: TRow, col2: string, select: number, type: number, test: boolean): number;
    SelectRow(row: TRow, select?: boolean, test?: boolean): boolean;
    SendExport(data: string, url: string, name: string): void;
    SetAttribute(row: TRow, col: string, attribute: string, value: string, refresh: boolean, undo: boolean): string;
    ...
    SetCellStyle(row: TRow, col: string, attrs: Object, refresh?: boolean): boolean;
    SetChecked(row: TRow, col: string, value: number): void;
    SetDependency(row: TRow, col: string, dependency: any, ancestors?: boolean, check?: number, refresh?: boolean): boolean;
    ...
    SetGanttLine(index: number, date1: string, date2: string, classArg: string, edit: boolean, update?: boolean, col?: string): boolean;
    SetGanttMain(row: TRow, col: string, plan: number, main: Object): void;
    SetGanttRun(row: TRow, col: string, run: Object): void;
    SetGanttRunBox(box: Object, adjust?: string, test?: boolean, minwidth?: number): boolean;
    ...
    SetStyle(Style: string, CSS: string, render: boolean): void;
    SetTimeout(code: any, time: number, ident: string, flags: number, data: any): boolean;
    SetValue(row: TRow, col: string, val: any, refresh?: boolean): void;
    SetWidth(col: string, dx: number): void;
    ShowCalendar(row: TRow, col: string, Calendar: TCalendar, Pos?: TPosition, Func?: Function, Date?: Object, always?: boolean): TCalendar;
    ShowCfg(source?: Object, func?: Function, options?: Object): TMenu;
    ShowCol(col: string): void;
    ShowColPages(): void;
    ShowColumns(attribute: string, caption: string, func: Function, options: TMenuItem[], optionscaption: string);
    ShowDefaults(row: TRow, col: string): boolean;
    ShowDetail(row: TRow, detail_grid_id: string, test?: boolean): boolean;
    ShowDialog(row: TRow, col: string, dialog: Object, leftalign: number, x: number, y: number): TMenu;
    ShowGanttCalendars(row: TRow, col: string, sort: boolean): void;
    ShowHint(row: TRow, col: string, staticArg?: boolean, test?: boolean): boolean;
    ShowMenu(row: TRow, col: string, Menu: TMenu, Pos: TPosition, Func: Function, Init: string, always?: boolean): TMenu;
    ShowMessage(message: string, importance?: number): void;
    ...
    ShowPopupGrid(row: TRow, col: string, data: string, width: number, height: number, Dialog?: TDialog, Pos?: TPosition): TGrid;
...
interface TMenu {
    ...
    Indent: number;
    Input: Object;
    Itemsrequiredattribute: TMenuItem[];
...
declare var Grids: {
    ...
    OnAfterSetStyle(grid: TGrid, Style: string, CSS: string, GanttCSS: string): void;
    OnAfterValueChanged(grid: TGrid, row: TRow, col: string, val: any): void;
    OnAutoFill(grid: TGrid, r1: TRow, c1: string, r2: TRow, c2: string, rdir: boolean, cdir: boolean, ro: TRow, co: string): boolean;
    OnAutoFillFinish(grid: TGrid, r1: TRow, c1: string, r2: TRow, c2: string, rdir: boolean, cdir: boolean, ro: TRow, co: string): void;
    OnAutoFillValue(grid: TGrid, row: TRow, col: string, orow: TRow, ocol: string, val: any, prevval: any, rowpos: number, colpos: number, orow2: TRow, ocol2: string, oldval: any, attrvalues: any[], attrnames: string[], errors: Object): any;
    OnAutoFillValues(grid: TGrid, Values: any[], Rows: TRow[], Cols: string[], orcnt: number, occnt: number, rcnt: number, ccnt: number, rdir: boolean, cdir: boolean): boolean;
    OnBlur(grid: TGrid, orow: TRow, ocol: string, orect: any[]): void;
    OnButtonClick(grid: TGrid, row: TRow, col: string, x: number, y: number): boolean;
    OnButtonListClick(grid: TGrid, row: TRow, col: string, item: string, index: number): void;
    OnCalculate(grid: TGrid, show: boolean, row: TRow, col: string, fixedonly: boolean): boolean;
    OnCalculateCell(grid: TGrid, row: TRow, col: string, val: any, show: boolean, Calc: any): any;
    OnCalculateFinish(grid: TGrid, show: boolean, row: TRow, col: string): void;
    OnCanColDelete(grid: TGrid, col: string, type: number, cols: string[]): boolean;
    OnCanDrop(grid: TGrid, row: TRow, togrid: TGrid, torow: TRow, type: number, copy: boolean, rows: TRow[]): number;
    ...
    OnClearChooseCells(grid: TGrid, row: TRow, col: string, selection: number, input: Object, replace: number): number[];
    OnClick(grid: TGrid, row: TRow, col: string, x: number, y: number, event: Event): boolean;
    OnClickPagerPage(Grid: TGrid, Pager: Object, Page: any, Page2: any, Active: boolean): boolean;
    OnCloseMenu(grid: TGrid, Menu: TMenu, source: Object, options: Object, saved: boolean): void;
    ...
    OnColsAdd(grid: TGrid, cols: string[], tocol: string, right: boolean, empty: boolean): boolean;
    ...
    OnCorrectDependencies(grid: TGrid, A: Object[], R: TRow[], error: boolean, row: TRow, col: string, slack: boolean): boolean;
    OnCorrectDependenciesFinish(grid: TGrid, A: Object[], deperr: boolean, consterr: boolean): boolean;
    ...
    OnCreateMenu(grid: TGrid, Menu: TMenu, source: Object, options: Object): boolean;
    OnCustomAjax(grid: TGrid, source: Object, data: string, Func: Function): boolean;
    OnCustomEndEdit(grid: TGrid, row: TRow, col: string, save: boolean, custom: any): string;
    OnCustomStartEdit(grid: TGrid, row: TRow, col: string, val: string, cell: HTMLElement, width: number): any;
    OnDataError(grid: TGrid, source: Object, result: number, message: string, data: string): void;
    ...
    OnDblClick(grid: TGrid, row: TRow, col: string, x: number, y: number, event: Event): boolean;
    ...
    OnDragGantt(grid: TGrid, row: TRow, col: string, name: string, start: number, end: number, oldstart: number, oldend: number, dir: number, XY: Object, keyprefix: string, clientX: number, clientY: number): number;
    OnDragGanttDependency(grid: TGrid, row: TRow, col: string, XYSrc: Object, torow: TRow, XYDest: Object, end: boolean, keyprefix: string, clientX: number, clientY: number): any;
    OnDragGanttRun(grid: TGrid, row: TRow, col: string, index: number, newValue: number, old: number, change: number, dir: number, start: boolean, XY: Object, keyprefix: string, clientX: number, clientY: number): number;
    OnDropCols(grid: TGrid, row: TRow, col: string, value: string, togrid: TGrid, torow: TRow, tocol: string, topos: number, drop: boolean): number;
    OnEditAttrs(grid: TGrid, row: TRow, col: string, value: any, oldvalue: any, attrvalues: any[], attrnames: string[], errors: Object): any;
    ...
    OnEndDrag(grid: TGrid, row: TRow, togrid: TGrid, torow: TRow, type: number, X: number, Y: number, copy: boolean, rows: TRow[]): number;
    OnEndDragCell(grid: TGrid, row: TRow, col: string, togrid: TGrid, torow: TRow, tocol: string, X: number, Y: number): void;
    OnEndDragGantt(grid: TGrid, row: TRow, col: string, name: string, start: number, end: number, oldstart: number, oldend: number, dir: number, XY: Object, keyprefix: string, clientX: number, clientY: number): boolean;
    OnEndDragGanttDependency(grid: TGrid, New: Object[], Old: Object[]): boolean;
    OnEndDragGanttRun(grid: TGrid, row: TRow, col: string, index: number, run: Object, type: number, dir: number, XY: Object, keyprefix: string, clientX: number, clientY: number): boolean;
    OnEndEdit(grid: TGrid, row: TRow, col: string, save: boolean, val: any, raw: string): any;
    ...
    OnExportInit(grid: TGrid, Cols: string[], Rows: string[], source: Object): boolean;
    ...
    OnFindType(grid: TGrid, row: TRow, col: string, type: string, val: any, calc: boolean): string;
    OnFocus(grid: TGrid, row: TRow, col: string, orow: TRow, ocol: string, pagepos: number, rect: any[], orect: any[]): void;
    OnFormula(grid: TGrid, row: TRow, col: string, value: any, oldvalue: any, formula: string, errors: Object): any;
    OnGanttChange(grid: TGrid, row: TRow, col: string, item: string, val: any, val2: any): boolean;
    OnGanttChanged(grid: TGrid, row: TRow, col: string, item: string, val: any, val2: any): void;
    OnGanttDragTip(grid: TGrid, row: TRow, col: string, tip: string, XY: Object, dir: number, start: number, end: number, duration: number, x: number, y: number): string;
    OnGanttFlagMove(grid: TGrid, row: TRow, col: string, index: number, date: number, togrid: TGrid, torow: TRow, tocol: string, toindex: number, todate: number): boolean;
    OnGanttFlagMoved(grid: TGrid, row: TRow, col: string, index: number, date: number, togrid: TGrid, torow: TRow, tocol: string, toindex: number, todate: number): void;
    OnGanttLineChange(grid: TGrid, index: number, date1: number, date2: number, classArg: string, edit: boolean, odate1: number, odate2: number, oclass: string, oedit: boolean): boolean;
    OnGanttLineChanged(grid: TGrid, index: number, date1: number, date2: number, classArg: string, edit: boolean, odate1: number, odate2: number, oclass: string, oedit: boolean): void;
    OnGanttMenu(grid: TGrid, row: TRow, col: string, Menu: TMenu, GanttXY: Object): boolean;
    OnGanttMenuClick(grid: TGrid, row: TRow, col: string, name: string, Item: TMenuItem, GanttXY: Object): boolean;
    OnGanttPage(grid: TGrid, col: string, left: number, width: number, dragrow: TRow, dragrun: Object): boolean;
    OnGanttRunBoxChanged(grid: TGrid, box: Object, old: Object): boolean;
    OnGanttRunBoxNew(grid: TGrid, box: Object): boolean;
    OnGanttRunDrop(grid: TGrid, row: TRow, col: string, drop: boolean, src: Object, index: number, keyprefix: string, x: number, y: number, togrid: TGrid, torow: TRow, tocol: string, cellx: number, accept: boolean, celly: number): number;
    OnGanttRunSelect(row: TRow, col: string, run: Object, index: number, select: boolean, source: Object): boolean;
    OnGanttSlack(grid: TGrid, row: TRow, col: string, bar: string, value: number, old: number, show: boolean): number;
    OnGanttStart(grid: TGrid): boolean;
    OnGanttTip(grid: TGrid, row: TRow, col: string, tip: string, XY: Object, name: string): string;
    OnGenerateId(grid: TGrid, row: TRow, newid: string): string;
    OnGetAvailability(grid: TGrid, row: TRow, col: string, value: number, src: string, Values: any[], start: number, end: number, min: number, max: number, group: string): boolean;
    OnGetAvailabilityClass(grid: TGrid, row: TRow, col: string, value: number, src: string, cls: string, group: string): string;
    OnGetBorder(grid: TGrid, row: TRow, col: string, border: any[], edge: number): any[];
    OnGetButtonList(grid: TGrid, row: TRow, col: string, list: string): string;
    OnGetCalendarDate(grid: TGrid, row: TRow, col: string, date: Date, text: string, classes: string[], range: boolean): string;
    OnGetClass(grid: TGrid, row: TRow, col: string, cls: string): string;
    OnGetColor(grid: TGrid, row: TRow, col: string, r: number, g: number, b: number): string;
    OnGetCopyValue(grid: TGrid, row: TRow, col: string, val: any): any;
    OnGetDefaultColor(grid: TGrid, row: TRow, col: string, r: number, g: number, b: number): number;
    OnGetDefaults(grid: TGrid, row: TRow, col: string, defaults: string): string;
    OnGetDependency(grid: TGrid, row: TRow, col: string, dep: any[], start: number, end: number, dur: number): void;
    ...
    OnGetFormat(grid: TGrid, row: TRow, col: string, format: string, edit: boolean): string;
    OnGetGanttFlagIcon(grid: TGrid, row: TRow, col: string, index: number, icon: string): string;
    OnGetGanttFlagIconHover(grid: TGrid, row: TRow, col: string, index: number, icon: string): string;
    OnGetGanttFlagText(grid: TGrid, row: TRow, col: string, index: number, text: string): string;
    OnGetGanttFlowHtml(grid: TGrid, row: TRow, col: string, index: number, width: number, comp: number, crit: number): string;
    OnGetGanttFormat(grid: TGrid, row: TRow, col: string, text: string): string;
    OnGetGanttHeader(grid: TGrid, val: string, index: number, date: number, nextdate: number, units: string, width: number, partial: number, col: string): string;
    OnGetGanttHtml(grid: TGrid, row: TRow, col: string, width: number, comp: number, crit: number, plan: number, index: number, txt: string, left: number, maxwidth: number, cls: string[]): string;
    OnGetGanttMenu(grid: TGrid, row: TRow, col: string, menu: string, GanttXY: Object): string;
    OnGetGanttRunClass(grid: TGrid, row: TRow, col: string, run: Object, index: number, cls: string): string;
    OnGetGanttRunRect(grid: TGrid, row: TRow, col: string, run: Object, index: number, Rect: number[], side: number): void;
    OnGetGanttRunSideRect(grid: TGrid, row: TRow, col: string, run: Object, index: number, Pos: number[], Rect: number[], side: number): void;
    OnGetGanttRunSideText(grid: TGrid, row: TRow, col: string, run: Object, index: number, text: string, width: number, side: number): string;
    OnGetGanttRunText(grid: TGrid, row: TRow, col: string, run: Object, index: number, text: string, width: number, left: number, maxwidth: number, cls: string[]): string;
    OnGetGanttSideHtml(grid: TGrid, row: TRow, col: string, width: number, comp: number, crit: number, plan: number, index: number, txt: string, side: number): string;
    OnGetGroupDef(grid: TGrid, col: string, def: string): string;
    OnGetHtmlValue(grid: TGrid, row: TRow, col: string, val: any): string;
    ...
    OnGetRowText(grid: TGrid, row: TRow, cols: string[], txt: string, sel: boolean): string;
    OnGetSortValue(grid: TGrid, row: TRow, col: string, val: any, desc: boolean, group: boolean): string;
    OnGetSuggest(grid: TGrid, row: TRow, col: string, suggest: string, formula: boolean): string;
    ...
    OnHint(grid: TGrid, row: TRow, col: string, hint: string, reason: number): string;
    OnIconClick(grid: TGrid, row: TRow, col: string, x: number, y: number): boolean;
    OnIncDate(date: number, units: string, count: number): number;
    OnKeyDown(grid: TGrid, key: string, event: Event, name: string, prefix: string): boolean;
    OnKeyPress(grid: TGrid, key: string, event: Event, name: string, prefix: string): boolean;
    OnKeyUp(grid: TGrid, key: string, event: Event, name: string, prefix: string): boolean;
    OnLinkClick(grid: TGrid, row: TRow, col: string, url: string, target: string): boolean;
    ...
    OnMenu(grid: TGrid, row: TRow, col: string, menu: TMenu, position: TPosition): boolean;
    OnMergeChanged(grid: TGrid, row: TRow, col: string, val: string, result: string[]): void;
    OnMouseDown(grid: TGrid, row: TRow, col: string, x: number, y: number, event: Event): boolean;
    OnMouseMove(grid: TGrid, row: TRow, col: string, x: number, y: number, event: Event): boolean;
    OnMouseOver(grid: TGrid, row: TRow, col: string, orow: TRow, ocol: string, event: Event): void;
    OnMouseUp(grid: TGrid, row: TRow, col: string, x: number, y: number, event: Event): boolean;
    OnMoveDragCell(grid: TGrid, row: TRow, col: string, togrid: TGrid, torow: TRow, tocol: string, X: number, Y: number): boolean;
    OnMoveFocus(grid: TGrid, rect: any[], orect: any[], Values: any[], Rows: TRow[], Cols: string[], SourceRows: TRow[], SourceCols: string[]): any;
    OnMoveFocusFinish(grid: TGrid, rect: any[], orect: any[], Values: any[], Rows: TRow[], Cols: string[], SourceRows: TRow[], SourceCols: string[]): void;
    OnMoveFocusValue(grid: TGrid, row: TRow, col: string, orow: TRow, ocol: string, value: any, oldvalue: any, attrvalues: any[], errors: string[]): any;
    ...
    OnPasteRow(grid: TGrid, row: TRow, cols: string[], values: string[], added: boolean): boolean;
    OnPasteRowFinish(grid: TGrid, row: TRow, cols: string[], values: string[], added: boolean): void;
    OnPasteValue(grid: TGrid, row: TRow, col: string, value: any, oldvalue: any, attrvalues: any[], attrnames: string[], errors: Object): any;
    OnPivot(Pivot: TGrid, Master: TGrid, Rows: string[], Cols: string[], Data: string[]): boolean;
    OnPivotFinish(Pivot: TGrid, Master: TGrid, Rows: string[], Cols: string[], Data: string[]): boolean;
    OnPivotFunc(grid: TGrid, id: string, col: string, master: TGrid, rows: TRow[], values: any[], result: any): any;
    ...
    OnReady(grid: TGrid, start: boolean): void;
    ...
    OnResultMask(grid: TGrid, row: TRow, col: string, val: string, errors: Object): number;
    OnRightClick(grid: TGrid, row: TRow, col: string, x: number, y: number, event: Event): boolean;
    ...
    OnRowFilter(grid: TGrid, row: TRow, show: boolean): boolean;
    OnRowIndex(grid: TGrid, values: string[]): boolean;
    OnRowMove(grid: TGrid, row: TRow, oldparent: TRow, oldnext: TRow): void;
    OnRowMoveToGrid(grid: TGrid, row: TRow, togrid: TGrid, torow: TRow, copy: boolean): number;
    OnRowResize(grid: TGrid, row: TRow, newheight: number, oldheight: number): number;
    OnRowSearch(grid: TGrid, row: TRow, col: string, found: boolean, func: Function, userdata: any): number;
    ...
    OnSaveMenu(grid: TGrid, Menu: TMenu, source: Object, options: Object): boolean;
    OnScroll(grid: TGrid, hpos: number, vpos: number, oldhpos: number, oldvpos: number): void;
    ...
    OnSelectGanttRunRect(grid: TGrid, r1: TRow, x1: number, y1: number, r2: TRow, x2: number, y2: number): boolean;
    OnSetChooseCells(grid: TGrid, range: Object, selection: number, input: Object, text: string): string;
    ...
    OnSetStyle(grid: TGrid, Style: string, CSS: string, GanttCSS: string): boolean;
    OnShowButtonList(grid: TGrid, row: TRow, col: string, Menu: TMenu, Pos: TPosition): void;
    OnShowCfg(grid: TGrid, Menu: TMenu): void;
    OnShowColumns(grid: TGrid, Menu: TMenu): boolean;
    OnShowDefaults(grid: TGrid, row: TRow, col: string, Menu: TMenu, Pos: TPosition): string;
    ...
    OnShowMenu(grid: TGrid, Menu: TMenu, source: Object, options: Object): boolean;
    ...
    OnStartDrag(grid: TGrid, row: TRow, col: string, more: boolean, rows: TRow[]): boolean;
    OnStartDragCell(grid: TGrid, row: TRow, col: string, html: string): string;
    OnStartDragGantt(grid: TGrid, row: TRow, col: string, name: string, start: number, end: number, dir: number, XY: Object, keyprefix: string, clientX: number, clientY: number): boolean;
    OnStartDragGanttDependency(grid: TGrid, row: TRow, col: string, XY: Object, color: number, start: boolean, keyprefix: string, clientX: number, clientY: number): any;
    OnStartEdit(grid: TGrid, row: TRow, col: string): boolean;
    OnSuggest(grid: TGrid, row: TRow, col: string, val: string, suggest: TMenu, formula: boolean): string;
    OnTestConstraints(grid: TGrid, row: TRow, col: string, type: string, change: number, d1: number, d2: number): number;
    OnTip(grid: TGrid, row: TRow, col: string, tip: string, clientX: number, clientY: number, X: number, Y: number): string;
    ...
    OnValidate(grid: TGrid, row: TRow, col: string, err: boolean, errors: Object): boolean;
    OnValidateError(grid: TGrid, rows: TRow[], cols: string[]): number;
    OnValueChanged(grid: TGrid, row: TRow, col: string, val: any, oldval: any, errors: Object): any;
...
declare function DragByMouse(tag: Object, event: Event, move?: number, html?: string, func?: Function, param?: Object): void;
...
declare function ShowCalendar(Calendar: TCalendar, Pos: TPosition, Func: Function, Date: any): TCalendar;
...
declare function ShowMenu(Menu: TMenu, Pos: TPosition, Func: Function, Init: string): TMenu;
...
declare function TGSetEvent(name: string, id: string, func: Function, ident: string): boolean;

declare function TreeGrid(Source: Source, tag?: string, id?: string): TGrid;
